...
export const AuthLayout = ({ page, imageSubText }) => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-primary/10">
      <div className="bg-white rounded-3xl shadow-lg flex w-full max-w-5xl overflow-hidden border border-primary/20">
        {/* Left Side */}
        <div className="hidden md:flex flex-col justify-evenly items-center bg-primary text-white w-1/2 p-8 relative">
          ...
          <img
            ...
            alt="Travel"
            className="rounded-2xl mt-8 mb-8 object-cover w-full h-80 shadow-lg border border-white/20"
          />
        </div>

        {/* Right Side (Form Area) */}
        <div className="flex flex-col w-[32rem] justify-center items-center relative">
          {page === "login" && <GoogleLoginPage />}
